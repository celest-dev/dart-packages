    ...
    return using((arena) async {
      ...
      try {
        ...
        void callback(
          ...
          final success = linux.glib.g_app_info_launch_default_for_uri_finish(
            result,
            error,
          );
          ...
          if (success == 0) {
            ...
            logger.warning('Failed to launch URL: $errorMessage');
        ...
        linux.glib.g_app_info_launch_default_for_uri_async(
          url.toNativeUtf8(allocator: arena).cast<Char>(),
          nullptr,
          nullptr,
